const N={
  ...
  ai:{local:{name:"Local Supreme AI",authority:"decision_and_policy"},external:{name:"Realtime GPT 3.0",authority:"verification_only",canAct:false,canExecuteTools:false,canApproveActions:false}},
